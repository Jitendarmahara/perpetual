...
export default function Dashboard() {
  ...
  return (
    <div className="h-dvh bg-[#0b0e11] text-[#f5f6f7] flex flex-col font-sans select-none overflow-hidden">
      <Header
      ...
      <div className="flex-1 min-h-0 flex flex-col lg:flex-row overflow-hidden">
        ...
        <div className="w-full lg:w-[360px] xl:w-96 min-h-0 lg:h-full overflow-y-auto overscroll-contain flex flex-col gap-2 border-b lg:border-b-0 border-border shrink-0 bg-[#0d1218] p-2 [scrollbar-gutter:stable]">
          <OrderBook
            market={selectedMarket}
            bids={market.bids}
            asks={market.asks}
            ...
            openOrders={trading.orderBookOrders}
            onPriceClick={() => {}}
          />
          <OrderForm
            market={selectedMarket}
